...
impl Public {
    pub fn new(modulo: i32, key: Vec<Vec<i32>>, add: i32, max_fuzz: i32, dim: usize) -> Self {
        Self { modulo, key, add, max_fuzz, dim }
    }
...
mod tests {
    ...
    use crate::keys::secret::Secret16;
    use super::*;
